...
class modelLoadHelper {
    ...
    changeLight(color, v0, v1, v2) {
        // const directionalLight2 = new THREE.DirectionalLight(0xffffff);
        // this.addModel().onAdd.directionalLight2.position.set(0, 70, 100).normalize();
        // this.scene.add(directionalLight2);
        // spotLight
        if (color){
            const colorList = color.slice(4,-1).split(', ')
            if (this.directionalLight2) {
                this.directionalLight2.color.set(colorList[0],colorList[1],colorList[2])
                // console.log(this.directionalLight2)
            }
        }

        if (this.directionalLight2) {
            this.directionalLight2.position.set(v0, v1, v2)
        }
